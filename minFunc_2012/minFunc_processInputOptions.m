...
function [verbose,verboseI,debug,doPlot,maxFunEvals,maxIter,optTol,progTol,method,...
    ...
    LS_type,LS_interp,LS_multi,DerivativeCheck, F_STREAK, F_PERCENT, F_MINITERS] = ...
...
F_STREAK = getOpt(o,'F_STREAK', 10);
F_PERCENT = getOpt(o,'F_PERCENT', 0);
F_MINITERS = getOpt(o,'F_MINITERS', 0);
